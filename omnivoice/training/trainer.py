...
class OmniTrainer:
    def __init__(
        ...
        # 5. Pre-load tokenizers for Evolution Audio (to avoid memory corruption later)
    ...
    def log_validation_sample(self, step: int):
        ...
        try:
            # 3. Use the existing model directly on its current device (usually GPU)
            ...
            if ref_audio and os.path.exists(ref_audio):
                ...
                try:
                    ...
                    # Ensure audio is on CPU for the generate method (it will be moved back as needed)
